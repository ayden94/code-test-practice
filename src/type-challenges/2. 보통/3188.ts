...
type TupleToNestedObject<T extends Array<PropertyKey>, U extends unknown> = T extends [infer F extends PropertyKey, ...infer R extends Array<PropertyKey>] ? { [K in F]: TupleToNestedObject<R, U> } : U
